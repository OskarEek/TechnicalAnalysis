...
class Stock:
    def __init__(self, ticker):
        ...
        self.last_stored_datapoint: Datapoint = None
    ...
    def update(self, data):
        ...
        if self.last_stored_datapoint == None:
            self.last_stored_datapoint = self.current_data
            return
        ...
        if self.store_new_price:
            self.datapoints.append(self.current_data)
            self.last_stored_datapoint = self.current_data
            self.store_new_price = False
            return
